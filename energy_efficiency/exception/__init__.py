...
class energy_exception(Exception):
    
    def __init__(self,error_msg:Exception,error_detail:sys):
        super().__init__(error_msg)
        self.error_msg=energy_exception.get_detailed_error_message(error_msg=error_msg,error_detail=error_detail)
    ...
    def __repr__(self):
        return energy_exception.__name__.str()